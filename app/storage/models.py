...
class ClaimVerificationItem(Base):
    ...
    verification_version: Mapped[str] = mapped_column(String(64), nullable=False, default="claim_rules_v1")
...
class EvidenceItem(Base):
    ...
    classification_version: Mapped[str] = mapped_column(String(64), nullable=False, default="rules_v1")
    risk_flags: Mapped[str] = mapped_column(Text, nullable=False, default="[]")
...
class VerificationItem(Base):
    ...
    risk_flags: Mapped[str] = mapped_column(Text, nullable=False, default="[]")
    raw_response: Mapped[str] = mapped_column(Text, nullable=False)
    verification_version: Mapped[str] = mapped_column(String(64), nullable=False, default="ai_verify_v1")
...
class RecommendationCard(Base):
    ...
    raw_response: Mapped[str] = mapped_column(Text, nullable=False, default="{}")
    writer_version: Mapped[str] = mapped_column(String(64), nullable=False, default="recommendation_writer_v1")
