...
The data layer intentionally contains only sources, fetch telemetry, runs,
normalized items, and one structured AI review per item. Historical stage
tables are not migrated; the local SQLite database may be recreated from this
metadata.
"""
